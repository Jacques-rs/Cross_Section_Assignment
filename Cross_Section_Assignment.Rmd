...
africa_df <- extract_sa_alt(cont = "Africa")
...
sa_df <- feature_adj_alt(sa_df)
africa_df <- feature_adj_alt(africa_df)
...
fmxdat::source_all("./code")
sa_df <- regression_format_country_alt(sa_df)
africa_df <- regression_format_country_alt(africa_df)
