...
It is important to note that with a lot of Covid data, the reliability of 
measurement error and false estimates is questionable. The fixed, and random 
effects might exacerbate this problem. In this case, it seems that OLS pooled 
regression, might perform better in explaining the behaviour in the defined 
'afflicted_rate' variable.
